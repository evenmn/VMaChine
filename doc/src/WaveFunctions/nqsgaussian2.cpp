#include "nqsgaussian2.h"
#include <cassert>
#include <iostream>
#include "../system.h"

NQSGaussian2::NQSGaussian2(System* system) :
        WaveFunction(system) {
...
double NQSGaussian2::calculateDistanceMatrixElement(const int i, const int j) {
    double dist = 0;
...
void NQSGaussian2::calculateDistanceMatrix() {
...
void NQSGaussian2::calculateDistanceMatrixCross(const int par) {
    for(int i=0; i<par; i++) {
...
void NQSGaussian2::calculateG(int changedCoord) {
...
void NQSGaussian2::updateParameters(const Eigen::MatrixXd parameters, const int elementNumber) {
...
void NQSGaussian2::initializeArrays(const Eigen::VectorXd positions) {
...
void NQSGaussian2::updateArrays(const Eigen::VectorXd positions, const int changedCoord) {
...
double NQSGaussian2::evaluateRatio() {
    return m_probabilityRatio;
}

double NQSGaussian2::computeGradient(const int k) {
...
double NQSGaussian2::computeLaplacian() {
    double sum = 0;
...
Eigen::VectorXd NQSGaussian2::computeParameterGradient() {
