...
'''
data1 = np.loadtxt("../data/energy_VMC_P2_D2_INT1_w1.000000_MC4194304.dat")
data2 = np.loadtxt("../data/energy_NQS_P2_D2_INT1_w1.000000_MC4194304.dat")
...
plt.axhline(asymptote, linestyle='--', color='r', label="Exact")
plt.plot(x, data1, label="$\eta=VMC$")
plt.plot(x, data2, label="$\eta=NQS$")
