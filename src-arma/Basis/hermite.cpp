...
void Hermite::setParameters(arma::vec parameters) {}

double Hermite::basisElement(const arma::uword n, arma::vec positions)
{
    double prod = 1;
...
double Hermite::basisElementDer(const arma::uword n, const arma::uword i, arma::vec positions)
{
...
double Hermite::basisElementSecDer(const arma::uword n, const arma::uword i, arma::vec positions)
{
    // i is the dimension we are derivating with respect to
...
double Hermite::basisElementPar(const arma::uword n, arma::vec position)
{
    return 0;
}
...
double Hermite::evaluate(double x, arma::uword n)
{
...
double Hermite::evaluateDerivative(double x, arma::uword n)
{
...
double Hermite::evaluateSecondDerivative(const double x, const arma::uword n)
{
