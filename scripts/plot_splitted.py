...
if __name__ == "__main__":
    ...
    RBM_2D_2P = [[0.07954, 0.4743, 1.0707, 1.7234, 3.0829, 5.5936, 7.9859, 12.6141, 23.6589],
                 [0.00872, 0.08102, 0.2047, 0.3739, 0.7691, 1.6377, 2.5215, 4.2752, 5.054],
                 [0.03402, 0.2082, 0.4678, 0.7611, 1.3926, 2.5507, 3.6733, 5.9493, 15.592],
                 [0.0368, 0.1851, 0.3983, 0.5884, 0.9212, 1.4051, 1.7910, 2.3896, 3.0129]]
