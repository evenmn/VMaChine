...
void System::setNumberOfElements(const unsigned long numberOfWaveFunctionElements) {
    m_numberOfElements = numberOfWaveFunctionElements;
    collectAllLabels();
}
...
void System::collectAllLabels() {
    ...
    */
    m_trialWaveFunction = total_string;
}
