...
void RBMGaussian2::calculateG(const unsigned int changedCoord) {
...
void RBMGaussian2::updateParameters(const Eigen::MatrixXd parameters, const unsigned short elementNumber) {
