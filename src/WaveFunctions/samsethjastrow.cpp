...
void SamsethJastrow::calculateG(const unsigned int changedCoord) {
...
void SamsethJastrow::calculateProbabilityRatio(const unsigned int particle) {
...
void SamsethJastrow::updateParameters(const Eigen::MatrixXd parameters, const unsigned short elementNumber) {
