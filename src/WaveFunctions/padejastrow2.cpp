...
void PadeJastrow2::calculateProbabilityRatio(int particle) {
    double ratio = 0;
    for(int j=particle+1; j<m_numberOfParticles; j++) {
...
double PadeJastrow2::computeGradient(const int k) {
